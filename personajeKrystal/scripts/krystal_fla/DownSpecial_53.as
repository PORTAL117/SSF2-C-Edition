package krystal_fla
{
   ...
   public dynamic class DownSpecial_53 extends MovieClip
   {
      ...
      public function DownSpecial_53()
      {
         super();
      ...
      internal function frame1() : *
      {
         ...
         {
            if(this.self.getGlobalVariable("charge") != null)
            {
               this.charge = this.self.getGlobalVariable("charge");
               this.self.setGlobalVariable("charge",null);
            }
         }
      }
      ...
      {
         if(this.self.getGlobalVariable("tossed") == false || this.self.getGlobalVariable("tossed") == null)
         {
         ...
         {
            this.self.setGlobalVariable("tossed",false);
         }
      }
